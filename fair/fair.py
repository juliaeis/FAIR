...
def get_gas_parameter_defaults(choose_gases=return_gas_namelist()):
    ...
    CHOOSE_params = pd.read_csv(Path(__file__).parent / "./aux/parameter-sets/Complete_gas_cycle_params.csv",header=[0,1],index_col=0).reindex(choose_gases,axis=1,level=1)
